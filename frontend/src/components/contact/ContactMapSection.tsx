        ...
        <div className="relative h-[280px] sm:h-[340px] md:aspect-[1280/400] md:h-auto rounded-2xl overflow-hidden border border-[#E6E0DA] bg-gray-100">
          ...
          <div className="absolute inset-0 flex items-end sm:items-center justify-center pb-4 sm:pb-0">
            <a
              ...
              className="bg-white shadow-2xl rounded-xl px-4 sm:px-8 py-3 sm:py-4 flex items-center gap-2 sm:gap-3 hover:shadow-3xl transition-shadow group max-w-[90vw]"
            >
              ...
              <div className="text-left min-w-0">
                <p className="font-syne font-bold text-sm sm:text-base text-[#221410] mb-0.5 truncate">Riva Properties Office</p>
