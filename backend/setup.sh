...
# Riva Properties Backend Quick Setup Script
# This script helps you set up the Riva Properties backend quickly
...
# Header
print_header "🏠 Riva Properties Backend Setup"
print_header "============================"
echo ""
...
MONGO_URI=mongodb://localhost:27017/rivaproperties
