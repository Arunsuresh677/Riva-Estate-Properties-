...
<head>
  ...
  <title>Riva Properties API</title>
...
<body>
  <div class="dash">
    ...
    <!-- Footer -->
    <div class="ftr">
      <p>&copy; ${new Date().getFullYear()} Riva Properties &nbsp;|&nbsp;
        <a href="/health">Health</a> &nbsp;|&nbsp;
        <a href="/status">Status</a> &nbsp;|&nbsp;
        <a href="https://rivaproperties.vercel.app" target="_blank">Website</a> &nbsp;|&nbsp;
